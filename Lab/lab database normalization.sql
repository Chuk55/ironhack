-- Primary Key = unique identifier (ie client_id) values cant cahnged.
select * from bank.account order by district_id ;
select * from bank.district;

-- DML command select/insert/update/merge/delete/call/explain plan/ call/ lock table/
-- DDL command create/ alter/ drop/ truncate / comment /rename
-- DCL command Grant/ revoke
-- TCL command commit/ rollback / savepoint / set transaction
